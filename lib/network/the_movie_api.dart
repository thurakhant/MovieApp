...
import 'package:movieapp/network/responses/get_actors_response.dart';
import 'package:movieapp/network/responses/get_credits_by_movies_response.dart';
import 'package:movieapp/network/responses/get_genres_response.dart';
...
abstract class TheMovieApi {
  ...
  Future<GetCreditsByMovieResponse> getCreditByMovieResponse(
      @Path('movie_id') String movieId,
      @Query(PARAM_API_KEY) String apiKey,
      @Query(PARAM_LANGUAGE) String language,
      @Query(PARAM_PAGE) int page,
